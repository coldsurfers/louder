  ...
  return (
    <div className={cx('InfoForm')}>
      <div className={cx('contents')}>
        ...
        <div className={cx('Line')}>
          <div className={cx('button-wrapper')} style={{ display: passwordVisible ? "none" : "block" }}>
            <Button onClick={onShowPassword}>비밀번호 변경하기</Button>
          </div>
        </div>
        <div className={cx('Line')} style={{display: passwordVisible ? "block" : "none"}}>
          <div className={cx('description')}>
            변경할 비밀번호를 입력해주세요.
          </div>
          ...
          <div className={cx('button-wrapper')}>
            ...
            <div className={cx('Button')}>
              <Button theme="cancel" onClick={onHidePassword}>취소하기</Button>
            </div>
          </div>
        </div>
        <div className={cx('Line')}>
