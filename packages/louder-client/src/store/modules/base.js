...
export default handleActions(
  {
    ...
    [SHOW_MODAL]: (state, action) => state.setIn(["visible", "modal"], true),
    [HIDE_MODAL]: (state, action) => state.setIn(["visible", "modal"], false),
    ...pender({
      type: CHANGE_EMAIL,
      onSuccess: (state, action) => {
    ...
    [SET_AUTH_CHECKED]: (state, action) => state.set("adminChecked", true),
    [SHOW_PASSWORD_CHANGING]: (state, action) =>
      state.setIn(["visible", "passwordChanging"], true),
    [HIDE_PASSWORD_CHANGING]: (state, action) =>
      state.setIn(["visible", "passwordChanging"], false),
    ...pender({
