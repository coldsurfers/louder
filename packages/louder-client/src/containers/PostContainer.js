...
class PostContainer extends Component {
    ...
    handleRemovePost = async () => {
        const { AdminActions, id, album_tracks, album_cover, post, history } = this.props;
        ...
        try {
            await AdminActions.filterTracks({ will_delete_tracks: album_tracks }, header);
    ...
    render() {
        const { post,
            ...
            settingVisible,
            id } = this.props;
        const { increaseCurrentTrackNumber,
            decreaseCurrentTrackNumber,
            setToZero,
            setToLast,
            setPlaying,
